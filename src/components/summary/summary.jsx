...
const SummaryContainer = () => {
  ...
  return (
    <div className="container">
      <div>BMR: {userCaloricGoals.calories} calories per day <br/>
      Current macro goals: <br/> {userMacroGoals.carbs}% carbs, {userMacroGoals.fats}% fats, {userMacroGoals.protein}% protein
      </div>
